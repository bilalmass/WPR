...
namespace Controller
{
    [Route("[controller]")]
    [ApiController]
    public class RegistreerPanellidController : ControllerBase
    {
        private readonly SignInManager<Gebruiker> _signInManager;
        private readonly UserManager<Gebruiker> _userManager;

        public RegistreerPanellidController(SignInManager<Gebruiker> signInManager, UserManager<Gebruiker> userManager)
        {
